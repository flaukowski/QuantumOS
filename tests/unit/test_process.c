...
#define TEST_ASSERT_EQUAL(expected, actual, message) TEST_ASSERT((expected) == (actual), message)
...
static void test_process_create(void) {
    ...
    process_create_params_t params = {.name = "test_process",
...
static void test_process_destroy(void) {
    ...
    process_create_params_t params = {.name = "test_destroy",
                                      .type = PROCESS_TYPE_USER,
                                      .priority = PRIORITY_NORMAL,
                                      .parent_pid = KERNEL_PROCESS_ID,
                                      .entry_point = (void *)dummy_process_entry,
...
static void test_process_states(void) {
    ...
    /* Create a test process */
    process_create_params_t params = {.name = "test_states",
                                      .type = PROCESS_TYPE_USER,
                                      .priority = PRIORITY_NORMAL,
                                      .parent_pid = KERNEL_PROCESS_ID,
                                      .entry_point = (void *)dummy_process_entry,
...
static void test_process_relationships(void) {
    ...
    process_create_params_t parent_params = {.name = "test_parent",
                                             .type = PROCESS_TYPE_USER,
                                             .priority = PRIORITY_NORMAL,
                                             .parent_pid = KERNEL_PROCESS_ID,
                                             .entry_point = (void *)dummy_process_entry,
    ...
    process_create_params_t child_params = {.name = "test_child",
                                            .type = PROCESS_TYPE_USER,
                                            .priority = PRIORITY_NORMAL,
...
static void test_process_statistics(void) {
    ...
    /* Create a process */
    process_create_params_t params = {.name = "test_stats",
                                      .type = PROCESS_TYPE_USER,
                                      .priority = PRIORITY_NORMAL,
                                      .parent_pid = KERNEL_PROCESS_ID,
                                      .entry_point = (void *)dummy_process_entry,
...
static void test_quantum_processes(void) {
    ...
    process_create_params_t params = {.name = "test_quantum",
